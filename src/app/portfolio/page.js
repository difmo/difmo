    ...
    <>
      <div className=" my-7">
        <div className="md:p-10 sm:mx-[2rem] md:my-3 my-7">
          <h2 className="md:text-3xl p-4 sm:p-0  text-4xl text-center font-lilita font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-deep-blue to-primary-orange   ">
            Portfolio
          </h2>
          ...
          {/* <div className="mt-4 text-center">
            <button
              ...
              className="px-6 py-2 bg-[#26baf6] text-white font-semibold rounded-lg shadow-md hover:bg-primary-orange transition duration-300"
            >
              View More
            </button>
          </div> */}
