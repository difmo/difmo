    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-cente bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-base sm:text-lg text-gray-700 mb-6 text-center md:text-left">
              Enhance your{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="w-full">
          <h2 className="font-bold text-3xl md:text-5xl leading-normal px-2  py-4 ">
            Navigating success with strategic{" "}
            <span className="text-primary-orange">
              Search Engine Optimization
            </span>
          </h2>
          <p className="text-xl  py-4 px-7">
            webdew's on-page specialists are your partners in digital success.
            We understand the intricacies of search engines and user behavior.
            We work closely with you to understand your goals, target audience,
            and brand voice. Through meticulous audits, keyword research,
            content optimization, and technical enhancements, we transform your
            website into a high-performing asset that delivers measurable
            results.
          </p>
          <button
