...
import { projects } from "../component/projects"; // Import the project data
  ...
  return (
    <div className="md:p-10 sm:mx-[2rem] md:my-3 my-7">
      ...
      <p className="text-gray-700 px-4 sm:px-0 sm:pt-2 text-[16px] leading-relaxed md:leading-loose tracking-wide text-justify">
        ...
        engagement, taking your digital presence to new heights.
      </p>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="flex-1 px-4">
                <h3 className="text-lg font-extrabold text-transparent md:text-xl font-lilita bg-clip-text bg-gradient-to-r from-deep-blue to-primary-orange ">
                  {project.title}
                </h3>
