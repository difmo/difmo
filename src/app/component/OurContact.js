      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 py-10">
        ...
        <div className="col-span-1 bg-white p-4  rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit}>
            ...
            />
            {errors.fullName && (
              <p className="text-xs italic mb-4 text-red-500">
                {errors.fullName}
              </p>
            )}
            ...
            />
            {errors.email && (
              <p className="text-xs italic mb-4 text-red-500">{errors.email}</p>
            )}
            ...
            <CustomButton
              type="submit"
              label="Submit"
              className="w-full p-5 py-2 text-white transition duration-300 bg-deep-blue rounded-lg hover:bg-primary-orange"
            />
          </form>
        </div>
      </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className="space-y-6">
      ...
      <div className="p-6 bg-gray-50 border rounded-lg shadow-md">
        <span className="block text-xl font-bold mb-2">Phone Number</span>
      ...
      {/* Email Address */}
      <div className="p-6 bg-gray-50 border rounded-lg shadow-md">
        <span className="block text-xl font-bold mb-2">Email Address</span>
      ...
      {/* Address */}
      <div className="p-6 bg-gray-50 border rounded-lg shadow-md">
        <span className="block text-xl font-bold mb-2">Address</span>
        <span>4/37 Vibhav Khand, Gomtinagar, Lucknow, Uttar Pradesh, 226010</span>
      </div>

      {/* Social Media */}
      <div className="p-6 bg-gray-50 border rounded-lg shadow-md flex justify-between items-center">
