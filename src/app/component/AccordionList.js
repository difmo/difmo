...
const AccordionList = () => {
  ...
  return (
    <>
      <div className="px-16">
        <h1 className="font-bold text-2xl md:text-5xl py-4 flex justify-center">
          Our <span className="text-primary-orange"> Process </span>
        </h1>
        <p className="text-xl flex justify-center p-2">
      ...
      <div className=" flex justify-center py-3">
        <p className="text-white bg-deep-blue p-2 rounded-xl border-2 border-gray-300">
          Gat a Quote
        </p>
      </div>
      {/* Our Deliverables */}
      <div className="bg-gray-100 py-10">
        <h1 className="font-bold text-2xl md:text-5xl flex justify-center py-2 ">
          Our Deliverables
        </h1>
        <p className="text-base sm:text-lg md:text-xl py-2  flex justify-center ">
          When you partner
