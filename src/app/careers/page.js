        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between p-4 rounded-lg">
            ...
            <p className="text-gray-700 text-[16px] leading-relaxed md:leading-loose tracking-wide text-justify">
              Find Your Fit At Difmo Technologies, our commitment to excellence
              shines through in our diverse and engaging work environments. We
              specialize in creating world-class web and mobile applications for
              global enterprises, leveraging our expertise across various
              sectors. We strive to be the easiest company to work with and for,
              fostering a collaborative talent ecosystem powered by enthusiastic
              and seasoned professionals. Our welcoming culture ensures that new
              joiners seamlessly integrate into our team, promoting a sense of
              belonging from day one. With offices located in Lucknow, India,
              and Singapore, we are dedicated to providing rewarding benefits,
              recognizing achievements, and maintaining a positive atmosphere.
              Join us at Difmo Technologies, where we offer work-life balance,
              steady career growth, and a vibrant community that celebrates
              innovation and teamwork. Discover your fit and be part of our
              journey!
            </p>
          </div>
